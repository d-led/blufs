...
ifeq ($(config),debug_x32)
  ...
  OBJDIR = ../../../obj/macosx/gmake/x32/Debug/custom_lua
...
ifeq ($(config),debug_x64)
  ...
  TARGET = $(TARGETDIR)/libcustom_lua.a
  OBJDIR = ../../../obj/macosx/gmake/x64/Debug/custom_lua
  DEFINES += -DBOOST_NO_VARIADIC_TEMPLATES -DDEBUG -D_DEBUG
  INCLUDES += -I/usr/local/include -I../../../deps/luabind -I../../../deps/Catch/single_include -I../../../deps/LuaState/include -I../../../deps/lua/lua-5.3.0/src
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_native)
  ...
  TARGET = $(TARGETDIR)/libcustom_lua.a
  OBJDIR = ../../../obj/macosx/gmake/native/Debug/custom_lua
  DEFINES += -DBOOST_NO_VARIADIC_TEMPLATES -DDEBUG -D_DEBUG
  INCLUDES += -I/usr/local/include -I../../../deps/luabind -I../../../deps/Catch/single_include -I../../../deps/LuaState/include -I../../../deps/lua/lua-5.3.0/src
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_x32)
  ...
  TARGET = $(TARGETDIR)/libcustom_lua.a
  OBJDIR = ../../../obj/macosx/gmake/x32/Release/custom_lua
...
ifeq ($(config),release_x64)
  ...
  TARGET = $(TARGETDIR)/libcustom_lua.a
  OBJDIR = ../../../obj/macosx/gmake/x64/Release/custom_lua
  DEFINES += -DBOOST_NO_VARIADIC_TEMPLATES -DRELEASE
  INCLUDES += -I/usr/local/include -I../../../deps/luabind -I../../../deps/Catch/single_include -I../../../deps/LuaState/include -I../../../deps/lua/lua-5.3.0/src
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_native)
  ...
  TARGET = $(TARGETDIR)/libcustom_lua.a
  OBJDIR = ../../../obj/macosx/gmake/native/Release/custom_lua
  DEFINES += -DBOOST_NO_VARIADIC_TEMPLATES -DRELEASE
  INCLUDES += -I/usr/local/include -I../../../deps/luabind -I../../../deps/Catch/single_include -I../../../deps/LuaState/include -I../../../deps/lua/lua-5.3.0/src
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
